...
def roll_dice(number_of_sides):
  ...
  print "Max possible value: {}".format(max_val)
  ...
  if guess > max_val:
    ...
    sleep(2)
    #Print roll numbers 
    print "First roll gave number: {}".format(first_roll)
    sleep(1)
    print "Second roll gave number: {}".format(second_roll)
    sleep(1)
    #get total of first and second roll 
    total_roll = first_roll + second_roll
    print "Total roll is {}".format(total_roll)
    print "Result..."
    sleep(1)
